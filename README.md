...
![EtherLab](https://i.ibb.co/9kPkpK5K/pic1.png)
...
![Compiling the contract](https://i.ibb.co/xK0DJZXN/pic3-1.png)
...
![Deploying the contract](https://i.ibb.co/TBw9MhZx/pic5.png)
You can fund the balance by copying its address: send **0.5 to 1 ETH** — this is enough for beginners.
![Deploying the contract](https://i.ibb.co/C3FdRsN1/pic6.png)
